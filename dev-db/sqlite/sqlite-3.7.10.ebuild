...
IUSE="debug doc +private +extensions +fts3 icu +readline secure-delete soundex tcl test +threadsafe unlock-notify"
...
src_configure() {
	einfo "Exposing SQLite3 private members"

	if use private; then
		append-cppflags -DSQLITE_PRIVATE=""
	fi
