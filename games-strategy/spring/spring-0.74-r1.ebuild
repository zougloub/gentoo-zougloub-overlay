...
SRC_URI="http://download.berlios.de/taspring-linux/spring_${MY_PV}_src.tar.bz2
	http://download2.berlios.de/taspring-linux/spring_${MY_PV}_src.tar.bz2
...
#	unpack spring_${MY_PV}_src.tar.bz2
#}
